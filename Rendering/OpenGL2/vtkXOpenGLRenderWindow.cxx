...
void vtkXOpenGLRenderWindow::CreateAWindow()
{
  ...
  if (this->OwnWindow)
  {
    ...
    XResizeWindow(this->DisplayId, this->WindowId,
      ((this->GetActualSizeDirectly()[0] > 0) ? static_cast<unsigned int>(this->GetActualSizeDirectly()[0]) : 300),
      ((this->GetActualSizeDirectly()[1] > 0) ? static_cast<unsigned int>(this->GetActualSizeDirectly()[1]) : 300));
    XSync(this->DisplayId, False);
  }
